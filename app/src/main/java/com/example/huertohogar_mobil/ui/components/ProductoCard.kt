...
// Función mágica para obtener la imagen por nombre (String -> ID)
fun obtieneImagen(context: Context, nombreImagen: String): Int {
    val resId = context.resources.getIdentifier(nombreImagen, "drawable", context.packageName)
    // Si no encuentra la imagen, devuelve un icono por defecto (asegúrate de tener ic_launcher o similar)
